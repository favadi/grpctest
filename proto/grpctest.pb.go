...
func (c *grpcTestClient) Unary(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
	err := grpc.Invoke(ctx, "/grpctest.GrpcTest/Unary", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _GrpcTest_Unary_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Request)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(GrpcTestServer).Unary(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/grpctest.GrpcTest/Unary",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GrpcTestServer).Unary(ctx, req.(*Request))
	}
...
var _GrpcTest_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "Unary",
			Handler:    _GrpcTest_Unary_Handler,
		},
	},
...
var fileDescriptor0 = []byte{
	...
	0xd4, 0xe2, 0x82, 0xfc, 0xbc, 0xe2, 0x54, 0xec, 0x2a, 0x8c, 0xde, 0x31, 0x72, 0x71, 0xb8, 0x17,
	...
	0x73, 0x48, 0xb4, 0xd8, 0x80, 0x51, 0x48, 0x8f, 0x8b, 0x35, 0x34, 0x2f, 0xb1, 0xa8, 0x92, 0x48,
	0x3d, 0x4e, 0x7a, 0x51, 0x3a, 0xe9, 0x99, 0x25, 0x19, 0xa5, 0x49, 0x7a, 0xc9, 0xf9, 0xb9, 0xfa,
	0x49, 0xc9, 0x39, 0xa9, 0x45, 0xb9, 0xf9, 0x79, 0x25, 0xfa, 0x30, 0x95, 0xfa, 0xe0, 0x40, 0xb6,
	0x86, 0x71, 0x93, 0xd8, 0xc0, 0x7c, 0x63, 0x40, 0x00, 0x00, 0x00, 0xff, 0xff, 0x73, 0x50, 0x57,
	0xd0, 0x86, 0x01, 0x00, 0x00,
}
